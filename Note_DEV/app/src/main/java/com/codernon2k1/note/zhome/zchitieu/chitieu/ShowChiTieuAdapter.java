...
public class ShowChiTieuAdapter extends BaseAdapter {
    List<UTLChiTieu> chiTieus = new ArrayList<>();

    public ShowChiTieuAdapter(List<UTLChiTieu> ghichus) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UTLChiTieu chiTieu = chiTieus.get(position);
        ...
        ngay.setText( chiTieu.getNgay() +"/"+ (chiTieu.getThang() +1 )+"/"+chiTieu.getNam() );
        gio.setText(chiTieu.getGio()+":"+chiTieu.getPhut());
        titile.setText(chiTieu.getTitle());
        tien.setText("-"+chiTieu.getTien());
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(v.getContext()).
                        ...
                        .setPositiveButton("Xóa", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                dataBase.QueryData(" DELETE FROM ChiTieu WHERE Id = " + chiTieu.getId() +"" );
                                ShowChiTieuActivity.show();
                            }
                        })
        ...
        sua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cal.set(chiTieu.getNam(),chiTieu.getThang(),chiTieu.getNgay(),chiTieu.getGio(),chiTieu.getPhut());
                ...
                houer1 =chiTieu.getGio();
                mini1 =chiTieu.getPhut();
                day1=chiTieu.getNgay() ;
                month1 = chiTieu.getThang() ;
                year1=chiTieu.getNam();
                tien1.setText(""+chiTieu.getTien());
                ngay1.setText(simpleDateFormat_day.format(cal.getTime()));
                gio1.setText(simpleDateFormat_gio.format(cal.getTime()));
                ghichu1.setText(chiTieu.getTitle());
                ...
                sua1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (tiens.equals("")){
                            ...
                            dataBase.QueryData("UPDATE ChiTieu SET ngay ="+day1 + ", thang="+month1+", nam="+year1+", gio="+houer1+",phut="+mini1+", tien="+tien3+", titile='"+title+"' WHERE Id="+chiTieu.getId()+";");
